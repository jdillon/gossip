...
import com.planet57.gossip.model.ModelMerger;
...
import com.planet57.gossip.source.URLSource;
import com.planet57.gossip.trigger.AlwaysTrigger;
    ...
    for (ProfileNode profile : model.getProfiles()) {
      ...
      for (String include : profile.getIncludes()) {
        ...
        if (includedProfile == null) {
          log.warn("Unable to include non-existent profile: {}", include);
          continue;
        }
