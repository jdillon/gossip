    ...
    extends RootNode
{
    ...
    private void mergeSources(final List<Source> source, final List<Source> target) {
        assert source != null;
        assert target != null;
    ...
    private void mergeProfiles(final List<Profile> source, final List<Profile> target) {
        assert source != null;
        assert target != null;
